...
<body>
	...
	<%
		...
		ResultSet rs = stmt.executeQuery(String.format("select * from shareParty%s where ott_name ='넷플릭스' order by shareParty_num desc ",bid));
		) {
		while (rs.next()) {       	           
 %> 
				        <a href="share_party.jsp?shareParty_num=<%=rs.getInt("shareParty_num")%>&ott_name=넷플릭스"><div class="swiper-slide"><img src ="img/netflix.png" /><div class ="number"><p class ="number1"><%=rs.getInt("shareParty_gauge")%></p><p class ="number2">/4</p></div></div></a>
 <%          
		}
     } catch(Exception e) {
         e.printStackTrace();
 ...
 %>				        
	...
	<%
		...
		Connection conn = DriverManager.getConnection(
				"jdbc:mariadb://localhost/movieverse17", "movieverse17", "shingu1718!");
		Statement stmt = conn.createStatement();
		ResultSet rs = stmt.executeQuery(String.format("select * from shareParty%s where ott_name ='왓챠' order by shareParty_num desc ",bid));
		) {
		while (rs.next()) {       	           
 %> 
				        <a href="share_party.jsp?shareParty_num=<%=rs.getInt("shareParty_num")%>&ott_name=왓챠"><div class="swiper-slide"><img src ="img/watcha.png" /><div class ="number"><p class ="number1"><%=rs.getInt("shareParty_gauge")%></p><p class ="number2">/4</p></div></div></a>
 <%          
		}
     } catch(Exception e) {
         e.printStackTrace();
 ...
 %>	
	...
	<%
		...
		Connection conn = DriverManager.getConnection(
				"jdbc:mariadb://localhost/movieverse17", "movieverse17", "shingu1718!");
		Statement stmt = conn.createStatement();
		ResultSet rs = stmt.executeQuery(String.format("select * from shareParty%s where ott_name ='디즈니플러스' order by shareParty_num desc ",bid));
		) {
		while (rs.next()) {       	           
 %> 
				        <a href="share_party.jsp?shareParty_num=<%=rs.getInt("shareParty_num")%>&ott_name=디즈니플러스"><div class="swiper-slide"><img src ="img/disnep.png" /><div class ="number"><p class ="number1"><%=rs.getInt("shareParty_gauge")%></p><p class ="number2">/4</p></div></div></a>
 <%          
		}
     } catch(Exception e) {
         e.printStackTrace();
 ...
 %>		
	...
	<%
		...
		Connection conn = DriverManager.getConnection(
				"jdbc:mariadb://localhost/movieverse17", "movieverse17", "shingu1718!");
		Statement stmt = conn.createStatement();
		ResultSet rs = stmt.executeQuery(String.format("select * from shareParty%s where ott_name ='웨이브' order by shareParty_num desc ",bid));
		) {
		while (rs.next()) {       	           
 %> 
				        <a href="share_party.jsp?shareParty_num=<%=rs.getInt("shareParty_num")%>&ott_name=웨이브"><div class="swiper-slide"><img src ="img/wavve_box.png" /><div class ="number"><p class ="number1"><%=rs.getInt("shareParty_gauge")%></p><p class ="number2">/4</p></div></div></a>
 <%          
		}
     } catch(Exception e) {
         e.printStackTrace();
