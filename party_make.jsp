	  ...
	  try (
             Connection conn = DriverManager.getConnection(
                ...
                Statement stmt = conn.createStatement();
                 ...
                 "insert into shareParty (header_num, ott_price, ott_name,shareParty_time, shareParty_gauge, shareHeader_bankName, shareHeader_accountNum, member_id) values (%d, %d,'%s', '%s', 1,'%s', '%s','%s');",
                userNum, ottprice, selectOption, curTime, bank, account, userId));
              } catch(Exception e){
                 e.printStackTrace();
              }
