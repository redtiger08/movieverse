    ...
    <header class="header">
        <section class="flex">
            ...
            <div class="navbarRight">
					...
					<c:otherwise>
						<a class ="login" href="#">${uesrNick}님</a>
			...
			<h3>어드밴처</h3>
				<div class="swiper-container">
				    <div class="swiper-wrapper">
				        ...
				        <a href="content_main.jsp?id=${release_date.id}&type=movie"><div class="swiper-slide"><img class ="poster" src="https://image.tmdb.org/t/p/w300/${release_date.poster_path }"><h2>${release_date.tvName}</h2></a>
				        </div>
            			</c:forEach>
				    </div>
				    <div class="swiper-button-next"></div>
